    ...
    <footer className="border-t bg-background">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          {/* Brand */}
          <div>
            <h3 className="font-bold text-lg mb-4">Thang</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Fresher Web Developer passionate about creating beautiful, functional web applications that make a
              difference.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              ...
              <Link
                ...
                rel="noopener noreferrer"
              >
                {/* Replace <Facebook /> with a valid icon or remove if not available */}
              ...
              <Link 
                ...
                rel="noopener noreferrer"
              >
                {/* Replace <Instagram /> with a valid icon or remove if not available */}
                <span className="h-5 w-5 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-xs text-muted-foreground">Always open to interesting conversations and opportunities.</p>
          </div>
        </div>

        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">© 2025 Thang. All rights reserved.</p>
          <p className="text-sm text-muted-foreground flex items-center mt-2 md:mt-0">
            Made with <Heart className="h-4 w-4 mx-1 text-red-500" /> coding web development
          </p>
        </div>
      </div>
    </footer>
