      ...
      <section className="bg-muted/50 py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
            {[
              "React", "Next.js", "TypeScript", "Node.js", "Git",
              "Python", "C++", "Java", "Swift", "JavaScript", "HTML", "CSS",
              "SQL Server", "MongoDB", "Docker"
            ].map((tech, index) => (
              <span 
                key={tech} 
                className="px-4 py-2 bg-background rounded-full border text-sm font-medium animate-slide-up hover:bg-primary/10 hover:border-primary/30 transition-colors"
